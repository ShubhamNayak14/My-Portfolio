...
import { Uidesign } from '../../Data/Data';
...
export const Blog = () => {
  ...
  const categories = ['All', 'Web Design', 'Mobile Design', 'Web & Mobile'];
  ...
  const filteredProjects = Uidesign.filter(
    (Uidesign) =>
      selectedCategory === 'All' || Uidesign.category === selectedCategory
  );
  return (
    <article className="portfolio" data-page="portfolio">
      <header>
        <h2 className="h2 article-title">UI Designs</h2>
      </header>
